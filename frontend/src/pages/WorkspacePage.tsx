...
import { useMe, useWorkspaceMembers, useInviteMember, useRemoveMember } from '../hooks/useWorkspace'
          ...
          <p className="text-xs text-gray-400 mt-0.5">
            ...
            {myRole && (
              <span className={`ml-2 px-1.5 py-0.5 rounded text-xs font-medium ${
                ...
                {myRole === 'OWNER' ? 'Propriétaire' : 'Membre'}
              </span>
            )}
          </p>
        </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">
                      {m.user_id === myUserId ? 'Vous' : m.role === 'OWNER' ? 'Propriétaire' : 'Membre'}
                    </p>
                  </div>
                </div>
